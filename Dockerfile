...
WORKDIR /src
COPY ["src/Web.Api/CleanArchitecture.WebApi/CleanArchitecture.WebApi.csproj", "src/Web.Api/CleanArchitecture.WebApi/"]
COPY ["src/Core/CleanArchitecture.Infrastructure/CleanArchitecture.Infrastructure.csproj", "src/Core/CleanArchitecture.Infrastructure/"]
...
RUN dotnet restore "./src/Web.Api/CleanArchitecture.WebApi/CleanArchitecture.WebApi.csproj"
COPY . .
WORKDIR "/src/src/Web.Api/CleanArchitecture.WebApi"
